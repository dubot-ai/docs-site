...
| --- | --- | --- |
| Public Help Center crawl | Searchable workspace knowledge | <Badge color="gray" size="sm">Current product build</Badge> |
| Document upload | Searchable workspace knowledge | <Badge color="gray" size="sm">Current product build</Badge> |
| Dashboard form | A versioned action or capability draft | <Badge color="gray" size="sm">Current product build</Badge> |
| Browser-extension recording | Candidate actions and guide evidence | <Badge color="yellow" size="sm">Controlled rollout</Badge> |
| Product Crawler | Product connection and discovery evidence | <Badge color="yellow" size="sm">Controlled rollout</Badge> |
| Authoring MCP | Versioned Test drafts from an authorized AI client | <Badge color="gray" size="sm">Current product build</Badge> |

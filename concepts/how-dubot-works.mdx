...
<figure className="product-figure">
  <img
    src="/assets/product/agent-configuration.png"
    alt="Wizard configuration in the Dubot application"
  />
  <figcaption>
    Configuration happens in the Dubot application; the SDK renders the published experience in

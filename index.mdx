...
<CardGroup cols={3}>
  <Card title="Explore the product" icon="blocks">
    Understand the authoring and end-user surfaces.

    [Open the product overview →](/surfaces/overview)
  </Card>
  <Card title="Install the SDK" icon="code">
    Add Dubot to a browser application.

    [Open the SDK quickstart →](/sdk/quickstart)
  </Card>
  <Card title="Plan an evaluation" icon="flag">
    Prove one customer outcome with clear controls and evidence.

    [Open the evaluation guide →](/pilots/pilot-guide)
  </Card>
</CardGroup>

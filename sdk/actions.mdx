...
<figure className="product-figure">
  <img
    src="/assets/product/clientside-callback-installation.png"
    alt="A client-side callback waiting to be registered from the SDK before it can be published"
  />
  <figcaption>
    Publishing stays unavailable until the host registers the callback and its input schema appears
    in Dubot.
  </figcaption>
</figure>

...
| Term | Meaning |
| --- | --- |
| Action | A governed operation available through a wizard or the end-user MCP action channel |
...
| Capability | Reusable context; Skill capabilities can also carry actions |
...
| Resource Center | Page-aware in-product help panel with content, search, Ask, and launches |

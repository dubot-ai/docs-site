...
<figure className="product-figure">
  <img
    src="/assets/product/action-type-picker.png"
    alt="The action type picker with Session API and client-side callback options"
  />
  <figcaption>
    Choose the execution branch that owns the operation. Backend API actions are not yet
    available.
  </figcaption>
</figure>
...
<figure className="product-figure">
  <img
    src="/assets/product/action-configuration.png"
    alt="An action configuration with its model-facing description, risk, policy, method, and endpoint"
  />
  <figcaption>
    Review the description, risk, policy, method, endpoint, schema, and response mask before
    publishing.
  </figcaption>
</figure>

...
![The action type picker with Session API and client-side callback options](/assets/product/action-type-picker.png)
...
![An action configuration with its model-facing description, risk, policy, method, and endpoint](/assets/product/action-configuration.png)

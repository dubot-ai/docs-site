...
![A Wizard presented as a Bubble with its composer and customer choices](/assets/product/wizard-bubble.png)
...
session and [Create and publish a capability](/guides/create-capability) for reusable behavior.

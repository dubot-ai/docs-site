...
<figure className="product-figure">
  <img
    src="/assets/product/capability-configuration.png"
    alt="A Skill capability selected with its name, model-facing description, and priority"
  />
  <figcaption>
    Select the capability type first. The type determines whether the capability can carry
    actions.
  </figcaption>
</figure>
...
<figure className="product-figure">
  <img
    src="/assets/product/capability-publish-dependencies.png"
    alt="The capability publish review listing the Skill and each included action dependency"
  />
  <figcaption>

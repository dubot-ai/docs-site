...
<figure className="product-figure">
  ...
  />
  <figcaption>
    Start with workspace trends, then open the supporting session, run, or action record.
  </figcaption>
</figure>
...
<figure className="product-figure">
  ...
  />
  <figcaption>
    Use outcome and latency filters to find the specific calls that need investigation.
  </figcaption>
</figure>

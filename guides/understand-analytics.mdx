...
![The workspace Overview with session, resolution, action, user, theme, and cost trends](/assets/product/analytics-overview.png)
...
![Action Activity with success, latency, call volume, outcome, user, and agent details](/assets/product/action-activity.png)

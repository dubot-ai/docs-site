...
<Frame caption="The Test session card starts a temporary browser-extension preview from Workspace settings.">
  <img
    src="/assets/product/browser-extension-test-session.jpg"
    alt="Workspace settings Test session card with a HoneyBook demo URL, Start test session button, and Test session overrides"
  />
</Frame>

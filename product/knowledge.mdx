...
Knowledge sources and the logged-in [Product Map](/concepts/product-map) serve different purposes. Knowledge explains the product. The Product Map describes where product concepts, controls, capabilities, and account-specific variants appear in the live experience.

...
<Note>
  This is the current dashboard crawl-progress component rendered with example source data. It
  shows the live heartbeat, moving discovery and crawl counts, failures, and the existing corpus
  remaining available during a re-crawl.
</Note>

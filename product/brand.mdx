...
<Note>
  This is the current dashboard Brand editor and live-preview component rendered with example
  settings. The preview switches between chat, Guidance, and Resource Center scenes and reports
  the current contrast status before publishing.
</Note>

...
<Note>
  This screenshot is a current SDK component render with example content. Your published copy,
  colors, capabilities, and page context determine the customer experience.
</Note>
